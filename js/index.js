//fui obrigada a pedir ajuda dos universitários, mas foi quase tudo. O que tá em branco é porque nem assim eu entendi e consegui fazer
...
class Game {
  ...
  checkGameOver = () => {
    ...
    if (crashed) {
      ...
      // tudo bem fazer aqui ou teria que ser no css?
      ctx.clearRect(0, 0, canvas.width, canvas.height);
      ctx.font = "40px Arial";
      ctx.fillStyle = "black";
